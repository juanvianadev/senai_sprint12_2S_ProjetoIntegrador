...
<head>
    ...
    <title>Condições Ambientais - Queimadas em São Paulo (Agosto/Setembro 2024)</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Condições Ambientais - Queimadas em São Paulo (Agosto/Setembro 2024)</h1>
        <div class="topic">
            <h2>Temperatura</h2>
            <p>Durante o período, foram registradas temperaturas acima da média, chegando a ultrapassar os <strong>35°C</strong> em algumas regiões do estado, principalmente no interior, como em Ribeirão Preto, onde os incêndios foram intensos.</p>
        </div>
        <div class="topic">
            <h2>Pressão Atmosférica</h2>
            <p>Não há dados específicos sobre a pressão atmosférica, mas o clima seco e quente, associado à baixa umidade, agravou as condições para as queimadas.</p>
        </div>
        <div class="topic">
            <h2>Altitude</h2>
            <p>As queimadas ocorreram predominantemente em regiões de baixa altitude, como canaviais e pastagens no interior paulista, onde o cultivo de cana-de-açúcar é comum.</p>
        </div>
        <div class="topic">
            <h2>Umidade Relativa</h2>
            <p>A umidade caiu para níveis críticos, abaixo de <strong>35%</strong> em diversas áreas, o que contribuiu significativamente para a propagação das chamas.</p>
        </div>
        <div class="topic">
            <h2>CO₂ e Qualidade do Ar</h2>
            <p>A qualidade do ar foi severamente afetada, com altos índices de partículas finas (<strong>PM2.5</strong>) devido à fumaça das queimadas. Em 9 de setembro, São Paulo registrou o pior índice de qualidade do ar do mundo em algumas regiões, como Ponte dos Remédios, devido ao acúmulo de material particulado.</p>
        </div>
        <div class="topic">
            <h2>Poeira e Partículas Suspensas</h2>
            <p>O material particulado, incluindo <strong>PM2.5</strong>, foi elevado, agravando os riscos à saúde respiratória. A fumaça e poeira chegaram a cobrir o céu em cidades como Ribeirão Preto e também afetaram capitais próximas.</p>
        </div>
        <div class="critical">
            <strong>Nota:</strong> Esses dados destacam as condições extremas enfrentadas durante as queimadas, que impactaram tanto o meio ambiente quanto a saúde da população.
        </div>
    </div>
    <footer>
        <p>Fontes: 
            <a href="https://pt.globalvoices.org/2024/10/13/entre-chamas-e-fumaca-brasil-tenta-combater-um-numero-recorde-de-incendios-florestais/" target="_blank">Global Voices</a>, 
            <a href="https://www.dw.com/pt-br/o-que-se-sabe-sobre-as-queimadas-em-s%C3%A3o-paulo/a-70051311" target="_blank">Deutsche Welle</a>.
        </p>
    </footer>
</body>
</html>
